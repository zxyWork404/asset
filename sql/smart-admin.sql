...
DROP DATABASE IF EXISTS `asset-admin-dev`;
CREATE DATABASE IF NOT EXISTS `asset-admin-dev` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `asset-admin-dev`;
