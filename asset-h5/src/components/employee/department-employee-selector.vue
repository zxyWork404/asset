...
<template>
  ...
  <div style="padding: 20px">
    ...
    <template v-if="!isRadio">
      <van-checkbox-group ref="checkboxGroup" v-model="selectEmployeeList" :max="max">
        <van-checkbox
          v-for="item in employeeList"
          :key="item.id"
    ...
    <br>
    <van-button v-if="!isRadio" size="small" style="margin:0 10px" type="primary" @click="checkAll">全选</van-button>
    <van-button v-if="!isRadio" size="small" type="info" @click="toggleAll">反选</van-button>
  </div>
